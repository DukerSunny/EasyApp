...
public class CircularProgressDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        if (mProgress >= 0f) {
            canvas.drawArc(mOvalBounds, 0, 360, false, mBottomPaint);
            canvas.drawArc(mOvalBounds, 0, mProgress * 360, false, mTopPaint);
        } else {
            canvas.drawArc(mOvalBounds, mStartArc, mArc, false, mTopPaint);
        }
    }
