...
public abstract class ListFramework<ITEM>
    ...
    //    private float mFloatingAlpha;
    //    private float mFloatingTranslucentAlpha;
    ...
    //                    if (mFloating.getAlpha() == mFloatingTranslucentAlpha) {
    //                        mFloating.setAlpha(mFloatingAlpha);
    //                    }
    //                } else {
    //                    if (mFloating.getAlpha() == mFloatingAlpha) {
    //                        mFloating.setAlpha(mFloatingTranslucentAlpha);
    //                    }
    //                }
    //            }
    //        }
    ...
    private View.OnClickListener mOnFloatingClickListener = new View.OnClickListener() {
        @Override
...
//            }
            if (mLoadMore != null) {
                ...
                mLoadMore.setLoadStatus(LoadStatus.Error);
            }
            //            if (mFloating != null) {
...
//            }
    ...
    public void setFloating(View view) {
        //        mFloating = view;
        //        if (mFloating != null) {
        //            mFloatingAlpha = mFloating.getAlpha();
        //            mFloatingTranslucentAlpha = mFloatingAlpha * 0.25f;
        //            mFloating.setOnClickListener(mOnFloatingClickListener);
        //        }
    }
