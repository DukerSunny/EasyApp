...
public abstract class RecyclerFramework<ITEM> implements PullableLayout.OnPullableListener {
    ...
    public RecyclerFramework(IFramework framework) {
        ...
        setLayoutManager(makeDefaultLayoutManager(mFramework.getActivity()));
        ...
        empty_solid = mFramework.findViewById(R.id.empty_solid);
        if (empty_solid != null) {
            mEmptyHelper = new EmptyHelper(empty_solid);
    ...
    protected abstract RecyclerHolder<ITEM> createHolder(View convertView, int viewType);
    ...
    protected void setItemDecoration() {
        addItemDecoration(new DividerItemDecoration(mFramework.getActivity(), null));
    }
    ...
    public void showRetryWhenEmptyIdle(boolean showRetryWhenIdle) {
        if (mEmptyHelper != null) {
    ...
    private class Adapter extends RecyclerAdapter<ITEM> {
        ...
        public RecyclerHolder<ITEM> onCreateViewHolder(ViewGroup parent, int viewType) {
            View convertView = createView(parent, viewType);
