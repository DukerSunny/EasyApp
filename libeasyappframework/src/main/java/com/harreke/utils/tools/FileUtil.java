    ...
    public static boolean copyFile(File source, File target) {
        ...
        if (source != null && source.exists() && source.isFile()) {
            try {
                ...
                success = false;
                Debug.e("Copy file to " + target.getAbsolutePath() + " error!");
            }
        }
    ...
    public static String readFile(File file) {
        ...
        if (file != null && file.exists() && file.isFile()) {
            try {
                ...
                content = null;
                Debug.e(TAG, "Read file " + file.getAbsolutePath() + " error!");
            }
        }
    ...
    public static boolean writeBitmap(File file, Bitmap bitmap) {
        ...
        if (file != null && bitmap != null) {
            try {
                ...
                success = false;
                Debug.e("Write bitmap " + file.getAbsolutePath() + " error!");
            }
        }
    ...
    public static boolean writeDrawable(File file, Drawable drawable) {
        ...
        if (file != null && drawable != null) {
            try {
                ...
                success = false;
                Debug.e("Write drawable " + file.getAbsolutePath() + " error!");
            }
        }
    ...
    public static boolean writeFile(File file, String content) {
        ...
        if (file != null && content != null) {
            try {
                ...
                success = false;
                Debug.e("Write file " + file.getAbsolutePath() + " error!");
            }
        }
