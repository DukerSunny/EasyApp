...
public class ViewAnim {
    ...
    public void startViewSimpleAnim(final View fromView, Rect finalBounds, int startOffsetY, int finalOffsetY, float startAlpha,
            float finalAlpha) {
        ...
        ViewHelper.setPivotX(fromView, 0f);
        ViewHelper.setPivotY(fromView, 0f);
        //计算拉伸比例
        ...
        ObjectAnimator scaleXAnim = ObjectAnimator.ofFloat(fromView, "scaleX", 1f, scaleX);
        ObjectAnimator scaleYAnim = ObjectAnimator.ofFloat(fromView, "scaleY", 1f, scaleY);
