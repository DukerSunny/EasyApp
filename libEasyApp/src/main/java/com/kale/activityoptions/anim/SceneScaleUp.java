...
public class SceneScaleUp extends TransitionAnims {
    ...
    public SceneScaleUp(Activity activity, float startX, float startY, float width, float height) {
        super(activity);
        // TODO 自动生成的构造函数存根
        mStartX = startX;
        mStartY = startY;
    ...
    public void playScreenAnims(final boolean isEnter) {
        ...
        ViewHelper.setPivotX(sceneRoot, 0f);
        ViewHelper.setPivotY(sceneRoot, 0f);
