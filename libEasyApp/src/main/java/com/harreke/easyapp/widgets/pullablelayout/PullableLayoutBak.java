 ...
 */
public class PullableLayoutBak extends FrameLayout implements ViewGroup.OnHierarchyChangeListener {
    ...
    private Runnable mLoadIndicatorCollapseRunnable = new Runnable() {
        ...
        public void run() {
            ...
            postDelayed(mLoadCompleteRunnable, PullableIndicatorBak.DURATION_MORPH);
        }
    };
    private PullableIndicatorBak mLoadIndicator;
    ...
    private Runnable mRefreshIndicatorCollapseRunnable = new Runnable() {
        ...
        public void run() {
            ...
            postDelayed(mRefreshCompleteRunnable, PullableIndicatorBak.DURATION_MORPH);
        }
    };
    private PullableIndicatorBak mRefreshIndicator;
    ...
    public PullableLayoutBak(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        if (mViewDelegate == null) {
            ...
            mRefreshIndicator = new PullableIndicatorBak(context);
            ...
            params = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            params.gravity = Gravity.CENTER_HORIZONTAL;
            mLoadIndicator = new PullableIndicatorBak(context);
    ...
    public void setLoadComplete(String toast) {
        if (toast == null) {
            ...
            postDelayed(mLoadIndicatorCollapseRunnable, DURATION_TOAST + PullableIndicatorBak.DURATION_MORPH);
        }
    }
    ...
    public void setRefreshComplete(String toast) {
        if (toast == null) {
            ...
            postDelayed(mRefreshIndicatorCollapseRunnable, DURATION_TOAST + PullableIndicatorBak.DURATION_MORPH);
        }
    }
