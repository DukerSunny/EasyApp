...
import com.harreke.easyappframework.adapters.viewpager.IPageAdapter;
import com.harreke.easyappframework.adapters.viewpager.ImagePageAdapter;
import com.harreke.easyappframework.frameworks.bases.IFramework;
import com.harreke.easyappframework.helpers.outers.VolleyImageLoadHelper;
import com.harreke.easyappframework.listeners.OnSlideClickListener;
import com.harreke.easyappframework.requests.IRequestCallback;
import com.harreke.easyappframework.tools.FrameworkInflater;
    ...
    private class Adapter extends ImagePageAdapter<ImageView> {
        ...
        public ImageView createPage(int position, String url) {
            ...
            if (image != null) {
                ...
                VolleyImageLoadHelper.loadImage(image, url, new SlideCallback(position));
            }
