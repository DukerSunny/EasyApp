...
public class Html {
    ...
    public static Spanned fromHtml(String source, OnTagClickListener tagClickListener) {
        Parser parser = new Parser();
        Spanned spanned = null;

        try {
            parser.setProperty(Parser.schemaProperty, new HTMLSchema());
            spanned = new HtmlToSpannedConverter(source, parser, tagClickListener).convert();
...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    public HtmlToSpannedConverter(String source, Parser parser, OnTagClickListener tagClickListener) {
        mSource = source;
    ...
    private static void startImg(SpannableStringBuilder text, Attributes attributes) {
        String src = attributes.getValue("", "src");
        Drawable d;

        d = FileUtil.readDrawable(AcFunRead.CacheDir + "/" + AcFunRead.DIR_ASSETS + "/" + src, (int) (48 * AcFunRead.Density),
                (int) (48 * AcFunRead.Density));
        if (d == null) {
            d = Resources.getSystem().
                    getDrawable(R.drawable.info_retry);
    ...
    private void endA(SpannableStringBuilder text) {
        ...
        if (where != len) {
            ...
            if (h.mHref != null) {
                ...
                text.setSpan(new TagClickableSpan("img", h.mHref, mTagClickListener), where, len,
                        Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
    }
