...
import com.harreke.utils.adapters.viewpager.IPageAdapter;
import com.harreke.utils.adapters.viewpager.ImagePageAdapter;
import com.harreke.utils.frameworks.IFramework;
import com.harreke.utils.listeners.OnSlideClickListener;
import com.harreke.utils.requests.IRequestCallback;
import com.harreke.utils.tools.FrameworkInflater;

import java.util.ArrayList;

public abstract class SlideHelper implements IPageAdapter<String, ImageView>, ViewPager.OnPageChangeListener {
    ...
    public SlideHelper(IFramework framework, int imageLayoutId, int indicatorLayoutId) {
        ...
        slide_page = (ViewPager) framework.findViewById(R.id.slide_page);
        slide_indicator = (LinearLayout) framework.findViewById(R.id.slide_indicator);
    ...
    private class Adapter extends ImagePageAdapter<ImageView> {
        ...
        public ImageView createPage(int position, String url) {
            ...
            if (image != null) {
                ...
                ImageLoadHelper.loadImage(image, url, new SlideCallback(position));
            }
